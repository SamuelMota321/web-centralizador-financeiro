...
describe("createCategoryAction", () => {
  it("cria com nome normalizado e revalida categorias e movimentacoes", async () => {
  ...
  it.each(["", "   ", "a".repeat(101)])("recusa nome invalido %j sem chamar a API", async (name) => {
  ...
  it("sessao expirada pede novo login", async () => {
...
describe("renameCategoryAction", () => {
  ...
  it("permite manter o proprio nome", async () => {
    existing(category());
...
describe("archiveCategoryAction", () => {
  ...
  it("500 mantem o usuario na tela com mensagem segura", async () => {
